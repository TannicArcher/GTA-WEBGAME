...
if(empty($bmoney))
{
$bank_money=rand(1,1000);
mysql_query("update krisha set money='".$bank_money."' where city='1' and house='bank';");
}
...
mysql_query("update users set money='".$grab_money."',police='".$police."',level='".$level."' where id='".$id."';");
mysql_query("update krisha set money='0' where city='1' and house='bank';");
print $lang['bank_grab_yeah']." ".$grab_money."$$<br/>";
}
...
mysql_query("update krisha set money='".$bmoney."',time='".time()."' where city='1' and house='bank';");
...
$dbid=$db_boss['id'];
$dbpass=$db_boss['pass'];
$messaga="<b>".$lang['bank_city1']."</b><br/>".$lang['bank_has_percents']."  ".$band_money."$$<br/>[<a href=\"./../mes.php?pass=$dbpass&amp;id=$dbid&amp;dbid=0&amp;mode=del\">".$lang['ok']."</a>]";
mysql_query("insert into messagi values(0,'0','$dbid','$messaga');");
}
else
{
