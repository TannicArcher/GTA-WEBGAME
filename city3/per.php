...
print "<b>Ты заработал 5$!И помог в строительстве нашего города!</b><br/>";
$money=$money+5;
mysql_query("update users set money='".$money."' where id='".$id."';");
print $lang['city1_at_you']." <b>$money $$</b>Можешь есче поработать!<br/>";

print "----<br/>";
print "<a href=\"rabota.php?id=$id&amp;pass=$pass\">Назад</a>";
print "<a href=\"http://wenz.org.ru/gta/game.php?id=$id&amp;pass=$pass\">".$lang['menu']."</a>";
