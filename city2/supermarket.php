...
print "<u>[".$lang['supermarket']."]</u><br/>";


$db=mysql_fetch_array(mysql_query("select * from krisha where city='2' and house='supermarket';"));
$bcity=$db['city'];
$bband=$db['band'];
$busers=$db['users'];
$bmoney=$db['money'];
...
mysql_query("update krisha set money='".$bank_money."' where city='2' and house='supermarket';");
}
...
<go href=\"supermarket.php?id=$id&amp;pass=$pass&amp;mode=grab\" method=\"post\">
...
mysql_query("update krisha set money='0' where city='2' and house='supermarket';");
print $lang['supermarket_grab_yeah']." ".$grab_money."$$<br/>";
}
...
{
mysql_query("update krisha set band='".$band."' where city='2' and house='supermarket'");
print $lang['rest_now_your_band_is_kr1'];
...
$dbid=$db_boss['id'];
$dbpass=$db_boss['pass'];
$messaga=$lang['rest_now_mes1']."<br/>[<a href=\"./../mes.php?pass=$dbpass&amp;id=$dbid&amp;dbid=0&amp;mode=del\">".$lang['ok']."</a>]";
...
$dbid=$db_boss['id'];
$dbpass=$db_boss['pass'];
$messaga="<b>".$lang['supermarket']."</b><br/>".$lang['supermarket_kr_another_band']." ".$band.".<br/>[<a href=\"./../mes.php?pass=$dbpass&amp;id=$dbid&amp;dbid=0&amp;mode=del\">".$lang['ok']."</a>]";
mysql_query("insert into messagi values(0,'0','$dbid','$messaga');");
...
mysql_query("update krisha set money='".$bmoney."',time='".time()."' where city='2' and house='supermarket';");
...
print "&gt;<a href=\"supermarket.php?id=$id&amp;pass=$pass\">".$lang['supermarket']."</a><br/>";
  ...
  default:
print $lang['supermarket_mes'];

if(!empty($bband)) print $lang['bank_krishuet'].": <b><a href=\"./../bands/viewband.php?id=$id&amp;pass=$pass&amp;band=".urlencode($bband)."\">".$bband."</a></b><br/>";
if(empty($bband) && $band!='') print "<a href=\"supermarket.php?id=$id&amp;pass=$pass&amp;mode=kr\">".$lang['bank_krisha']."</a><br/>";
elseif(!empty($bband) && $bband!=$band && $band!='')
{
print "<a href=\"supermarket.php?id=$id&amp;pass=$pass&amp;mode=at_kr\">".$lang['bank_att_krisha']."</a><br/>";
}
if($band==$bband && $band!='') print "<a href=\"supermarket.php?id=$id&amp;pass=$pass&amp;mode=gp\">".$lang['bank_get_percent']."</a><br/>";
  break;
}
