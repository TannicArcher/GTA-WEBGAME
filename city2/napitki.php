...
print "<u>[".$lang['napitki']."]</u><br/>";
print "<u>".$lang['napitki_1']."</u><br/>";
...
print "<a href=\"napitki.php?id=$id&amp;pass=$pass&amp;p=25\">".$lang['cola']."</a>(25$$)<br/>";
print "<a href=\"napitki.php?id=$id&amp;pass=$pass&amp;p=15\">".$lang['sprite']."</a>(15$$)<br/>";
print "<a href=\"napitki.php?id=$id&amp;pass=$pass&amp;p=10\">".$lang['fanta']."</a>(10$$)<br/>";
print "<a href=\"napitki.php?id=$id&amp;pass=$pass&amp;p=5\">".$lang['mountin_dew']."</a>(5$$)<br/>";
